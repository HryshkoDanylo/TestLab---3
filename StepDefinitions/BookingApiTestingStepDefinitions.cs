...
namespace lab_3.StepDefinitions
{
    ...
    [Binding]
    public class BookingApiTestingStepDefinitions : Client
    {
        public BookingModel bookingObject { get; set; }
        ...
        [When(@"I send a GET request to ""([^""]*)"" and tell the booking id:(.*)")]
        public void WhenISendAGETRequestToAndTellTheBookingId(string url, int id)
        {
        ...
        {
            bookingObject = new BookingModel(booking_id);
        }
        ...
        {
            bookingObject = new BookingModel(firstname, lastname, totalprice, bool.Parse(depositpaid), checkin, checkout);
        }
